...
$query = query_PDO("SELECT * FROM products WHERE product_id = " . ($_GET['id']) ." ");
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="product_tags" id="" cols="30" rows="3" class="form-control"><?php echo $product_tags; ?></textarea>
    </div>
