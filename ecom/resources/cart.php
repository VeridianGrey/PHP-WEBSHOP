...
$query = query_PDO("SELECT * FROM products WHERE product_id=" . $_GET['add'] . " ");
confirm($query);
...
$query = query_PDO("SELECT * FROM products WHERE product_id = " . $id . " ");
confirm($query);
...
<img width='100' src='../resources/{$display_image}'
